...
map("n", "<leader>tf", actions.focus_current_study_tree, "Focus current study tree")
map("n", "<leader>ta", actions.open_ajay_tree, "Ajay notes tree")
...
map("n", "<leader>oa", actions.open_ajay_index, "Open Ajay notes")
