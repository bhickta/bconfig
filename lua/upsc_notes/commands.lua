...
vim.api.nvim_create_user_command("Ajay", actions.open_ajay_index, {})
vim.api.nvim_create_user_command("AjayTree", actions.open_ajay_tree, {})
vim.api.nvim_create_user_command("FocusTree", actions.focus_current_study_tree, {})
