...
function M.global(actions)
  return {
    ...
    -- Terminals may report the punctuation keys with or without Shift.
    map("n", "<C-,>", smart_split("move_cursor_left"), "Move to left split"),
    map("n", "<C-lt>", smart_split("move_cursor_left"), "Move to left split"),
    ...
    map("n", "<C-.>", smart_split("move_cursor_right"), "Move to right split"),
    map("n", "<C->>", smart_split("move_cursor_right"), "Move to right split"),
    map("n", "<C-l>", smart_split("move_cursor_right"), "Move to right split"),
    map("t", "<C-,>", terminal_smart_split("move_cursor_left"), "Move to left split"),
    map("t", "<C-lt>", terminal_smart_split("move_cursor_left"), "Move to left split"),
    ...
    map("t", "<C-.>", terminal_smart_split("move_cursor_right"), "Move to right split"),
    map("t", "<C->>", terminal_smart_split("move_cursor_right"), "Move to right split"),
    ...
    map("t", "<C-Up>", terminal_smart_split("resize_up"), "Resize split up"),
    map("t", "<C-Down>", terminal_smart_split("resize_down"), "Resize split down"),
    map("t", "<C-Left>", terminal_smart_split("resize_left"), "Resize split left"),
    map("t", "<C-Right>", terminal_smart_split("resize_right"), "Resize split right"),
    map("n", "<M-k>", smart_split("resize_up"), "Resize split up"),
    map("n", "<M-j>", smart_split("resize_down"), "Resize split down"),
    map("n", "<M-h>", smart_split("resize_left"), "Resize split left"),
    map("n", "<M-l>", smart_split("resize_right"), "Resize split right"),
    map("t", "<M-k>", terminal_smart_split("resize_up"), "Resize split up"),
    map("t", "<M-j>", terminal_smart_split("resize_down"), "Resize split down"),
    map("t", "<M-h>", terminal_smart_split("resize_left"), "Resize split left"),
    map("t", "<M-l>", terminal_smart_split("resize_right"), "Resize split right"),
    ...
    map("n", "<leader>fo", actions.find_recent_files, "Find recent files and Folder Views"),
    ...
    map("n", "<leader>sg", require("upsc_notes.web_lookup").search, "Quick web lookup"),
    map("v", "<leader>sg", require("upsc_notes.web_lookup").search, "Look up selection on the web"),
    map("n", "<leader>sc", require("upsc_notes.web_lookup").close, "Close web lookup"),
    ...
    map("n", "<C-Space>", command("ToggleTerm"), "Toggle terminal"),
    map("i", "<C-Space>", "<esc>" .. command("ToggleTerm"), "Toggle terminal"),
    map("t", "<C-Space>", command("ToggleTerm"), "Toggle terminal"),
    map("n", "<C-'>", command("ToggleTerm"), "Toggle terminal"),
    map("i", "<C-'>", "<esc>" .. command("ToggleTerm"), "Toggle terminal"),
    map("t", "<C-'>", command("ToggleTerm"), "Toggle terminal"),
...
function M.dashboard_buttons(icons)
  ...
  return {
    ...
    { key = "o", label = dashboard_icons.recent .. "  Recent files and Folder Views", command = "<cmd>lua require('upsc_notes.actions').find_recent_files()<CR>" },
