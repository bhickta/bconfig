...
assert_eq(60 - vim.fn.line("w0"), expected_offset, "cursor should sit twenty percent from the top")

viewport.setup()
vim.api.nvim_win_set_cursor(win, { 80, 0 })
vim.api.nvim_exec_autocmds("CursorMoved", { buffer = buf })
assert_eq(80 - vim.fn.line("w0"), expected_offset, "cursor movement should restore the twenty-percent position")
